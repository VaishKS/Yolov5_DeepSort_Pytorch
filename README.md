...
<div align="center">
<p>
<img src="MOT16_eval/demo1.gif" width="400"/>
</p>
<br>
</div>
...
`git clone --recurse-submodules https://github.com/VaishKS/Yolov5_DeepSort_Pytorch.git`

If you already cloned and forgot to use `--recurse-submodules` you can run `git submodule update --init`

2. Make sure that you fulfill all the requirements: Python 3.8 or later with all [requirements.txt](https://github.com/VaishKS/Yolov5_DeepSort_Pytorch/blob/master/requirements.txt) dependencies installed, including torch>=1.7. To install, run:
